...
####
####
#### test implementation of Local Adaptive Threshold
####
####


class GenerateLocalAdaptiveThreshold(analysistask.ParallelAnalysisTask):
    ...
    def get_neighboring_fovs(self, fragmentIndex):
        ...
        neighboring_fovs = np.argsort(position_df['distance'].values)[0: 1 + self.parameters['neighbors']]
